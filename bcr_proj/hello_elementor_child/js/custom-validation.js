document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch(ajax_object.holidays_url)
        ...
        .then(data => {
            holidays = data; // Aquí obtenemos el array de fechas festivas

            // Mostrar los días festivos en la lista
            holidays.forEach(holiday => {
                const listItem = document.createElement('li');
                listItem.textContent = holiday; // Usamos directamente el valor de la fecha
    ...
    function validateStartDate() {
        ...
        if (errorMessage) {
            alert(errorMessage);
            startDateInput.value = ''; // Limpiar el campo si hay error
        }
    }
    ...
    function validateEndDate() {
        ...
        if (errorMessage) {
            alert(errorMessage);
            endDateInput.value = ''; // Limpiar el campo si hay error
        }
    }
